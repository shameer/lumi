...
setMethod('density', signature(x='ExpressionSet'), 
	...
	lwd=1, xlim=NULL, index.highlight=NULL, color.highlight=2, symmetry=NULL, addLegend=TRUE, subset=NULL, main='',...) 
{
...
setMethod('plotCDF', signature(x='ExpressionSet'), 
	function(x, reverse=TRUE, logMode=TRUE, xlab = NULL, ylab = "Cumulative density", col=1:dim(x)[2], 
