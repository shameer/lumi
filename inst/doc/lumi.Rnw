...
> # example.lumi <- lumiR.batch(fileName, lib.mapping='lumiHumanIDMapping.db', sampleInfoFile='sampleInfo.txt')		# Not Run
...
> produceGEOSampleInfoTemplate(lumi.example, lib.mapping = 'lumiHumanIDMapping.db', fileName = "GEOsampleInfo.txt")
## After editing the 'GEOsampleInfo.txt' by filling in sample information
> produceGEOSubmissionFile(lumi.N.Q, lumi.example, lib='lumiHumanIDMapping.db', sampleInfo='GEOsampleInfo.txt')
\end{Sinput}
