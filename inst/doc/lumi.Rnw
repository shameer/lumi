...
By default, function \Rfunction{lumiN} performs robust spline normalization (RSN) algorithm. \Rfunction{lumiN} also provides options to do \verb+"quantile", "loess", "vsn"+ normalization. See help of \Rfunction{lumiN} for details.
