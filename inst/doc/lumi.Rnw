...
Du, P., Kibbe, W.A. and Lin, S.M., "lumi: a pipeline for processing Illumina microarray", (under review). 
...
if(require(GO.db) & require(annotate) & require(lib, character.only=TRUE)) {
